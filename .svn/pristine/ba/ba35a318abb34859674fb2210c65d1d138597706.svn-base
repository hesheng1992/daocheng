 ...
 */
public class ClearEditTextNew extends FrameLayout {
    ...
    public ClearEditTextNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ClearEditTextNew(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        LayoutInflater.from(getContext()).inflate(R.layout.clear_edittext_new, this, true);
