	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		...
		if (resultCode == RESULT_OK)
		{
			...
			case REQUEST_CODE:
				...
				{
					//modify by big_love 2015/12/16
//					photo_path = cursor.getString(cursor.getColumnIndex(MediaStore.Images.Media.DATA));
					photo_path = SelectPhotoUtil.newGetPath(CaptureActivity.this, data.getData());
//					photo_path = SelectPhotoUtil.oldGetPath(CaptureActivity.this, data);
//					photo_path = getFilePath(data);
				}
				cursor.close();
				...
				new Thread(new Runnable()
				{
					...
					public void run()
					{
						...
						if (result != null)
						{
							Log.i("tonghua", "scanningImage（） 成功");
						...
						{
							Log.i("tonghua", "scanningImage（） 结果为空");
							Message m = mHandler.obtainMessage();
	 ...
	 * @return
	 */
	public Result scanningImageOld(String path)
	{
		Log.i("tonghua", "文件路径："  + photo_path);
