...
//					paint);
			...
			} else
			{
				...
				{
//					canvas.drawCircle(frame.left + point.getX(), frame.top + point.getY(), 6.0f, paint);//enid
				}
			}
			if (currentLast != null)
			{
				...
				{
//					canvas.drawCircle(frame.left + point.getX(), frame.top + point.getY(), 3.0f, paint);//enid
				}
			}
