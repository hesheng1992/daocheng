...
public class BaseSharedPref {
	...
	public static void setLong(String key, long value, Context c) {
		SharedPreferences.Editor editor = c.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE).edit();
		editor.putLong(key, value);
		editor.commit();
	}

	public static long getLong(String key, Context c) {
		return c.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE).getLong(key, PREFS_INT_INVALID);
	}
