 ...
 */
public class ReturnProductListdapter extends BaseRecyclerAdapter<ReturnProductVH, OrderCommodity> {
    ...
    public ReturnProductListdapter(List<OrderCommodity> list) {
        super(list);
    }
    ...
    @Override
    public ReturnProductVH onRealCreateViewHolder(ViewGroup parent, int viewType) {
        return new ReturnProductVH(parent,0).setItemOperationListener(mItemOperationListener);
    }

    @Override
    public void onRealBindViewHolder(ReturnProductVH holder, int position) {
    ...
    public interface ItemOperationListener {
        void onItemClickSelectChange(int number);
